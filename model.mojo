...
struct GeometricParameters(Copyable):
    ...
    fn clone(self) -> GeometricParameters:
        return GeometricParameters(
            L_1=self.L_1, L_2=self.L_2, L_3=self.L_3, L_4=self.L_4,
            h_1=self.h_1, h_2=self.h_2, h_3=self.h_3, h_4=self.h_4,
            theta_1=self.theta_1, theta_2=self.theta_2, theta_3=self.theta_3, theta_4=self.theta_4,
            H=self.H, d=self.d
        )
...
fn get_beam_stiffness(mat: MaterialProperties, geom: GeometricParameters, omega: Float64, l: Float64, h: Float64) -> Matrix[6]:
    var A = geom.area(h)
...
fn calculate_amplification_ratio(mat: MaterialProperties, geom: GeometricParameters) -> Float64:
    ...
    return x_out_y / (x_in1_x - x_in2_x)

fn calculate_input_stiffness(mat: MaterialProperties, geom: GeometricParameters) -> Float64:
    var K_sys = assemble_full_system_matrix(mat, geom, 0.0)
...
fn calculate_natural_frequencies(mat: MaterialProperties, geom: GeometricParameters, m_out: Float64, m_in: Float64) -> List[Float64]:
    var start_f = 100.0
    var end_f = 10000.0
    var step_f = 10.0
...
fn calculate_ratio_ref23(mat: MaterialProperties, L: Float64, h: Float64, d: Float64, theta_deg: Float64) -> Float64:
...
fn calculate_ratio_ref28(mat: MaterialProperties, L: Float64, h: Float64, d: Float64, theta_deg: Float64) -> Float64:
    var theta_rad = theta_deg * pi / 180.0
    var A = d * h
    var I = (d * h**3) / 12.0
    var K_l = mat.E * A / L
...
fn calculate_ratio_ref31(mat: MaterialProperties, L: Float64, h: Float64, d: Float64, theta_deg: Float64) -> Float64:
    var theta_rad = theta_deg * pi / 180.0
    var A = d * h
    var I = (d * h**3) / 12.0
    var K_l = mat.E * A / L
