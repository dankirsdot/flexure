...
fn generate_parallel_comparisons(
    ...
    for i in range(len(H_values)):
        ...
        results.ref23.append(ratio_ref23(mat, L0, h_flex, d, theta_deg) * factor)
        results.ref25.append(ratio_ref25_parallel(mat, L0, h_flex, d, H) * factor)
        results.ref26.append(ratio_ref26_parallel(mat, L0, h_flex, d, H) * factor)
        results.ref31.append(ratio_ref31_parallel(mat, L0, h_flex, h_link, d, H, L_link) * factor)
