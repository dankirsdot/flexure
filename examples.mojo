...
fn example_rhombic_single_point():
    ...
    print(
        "Expected ratio (approx 2*cot theta):",
        2.0 / tan(theta_deg * pi / 180.0),
    )
    results.dump()
...
fn example_parallel_single_point():
    ...
    var output_mass = _get_output_mass()
    var mat = aluminum_6061()
    var results = compute_results(mat, geom, output_mass, single_sided=True)

    print(
        "Parameters: equivalent theta =",
        theta_target,
        "deg, H =",
        H * 1e3,
        "mm",
