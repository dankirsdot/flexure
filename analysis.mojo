...
fn make_output_mass_from_block(width: Float64, height: Float64, depth: Float64, rho: Float64) -> OutputMass:
    """
...
struct AmplifierResults(Copyable, Movable):
    ...
    fn __init__(out self, ratio: Float64, stiffness: Float64, var freqs: List[Float64]):
        """
